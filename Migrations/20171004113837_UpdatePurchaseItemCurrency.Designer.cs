...
namespace ShopTracker.Migrations
{
    ...
    [Migration("20171004113837_UpdatePurchaseItemCurrency")]
    partial class UpdatePurchaseItemCurrency
    {
            ...
            modelBuilder.Entity("ShopTracker.Models.Item", b =>
                {
                    ...
                    b.HasOne("ShopTracker.Models.Purchase", "Purchase")
                        .WithOne("Item")
                        .HasForeignKey("ShopTracker.Models.Item", "PurchaseID")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("ShopTracker.Models.Purchase", b =>
                {
                    ...
                    b.HasOne("ShopTracker.Models.Group")
                        .WithMany("Purchases")
